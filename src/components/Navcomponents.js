                ...
                <div className="row justify-content-center bg-info">
                    <div className="col-lg-10" id="back">
                        ...
                        <div className="text-center text-light" id="back-text">
                            <h1>Hi! There, I am Parimi Monish.</h1>
            ...
            <div class="container-lg">
                <div class="row justify-content-center align-item-center">
                    <div class="col-md-5 text-center text-md-start border border-secondary" style={{backgroundColor: "rgb(214, 213, 213)"}}>
                        <h1>
                            <div class="display-4">Parimi Monish</div>
                            <div class="lead text-muted"><i class="bi bi-file-earmark-person"></i> A Learner | ML Enthusiast</div>
                        </h1>
                        <hr />
                        <div class="contact">
                            <p class="lead pt-0">I'm currently learning Machine Learning, Android App Development and MERN Stack.</p>
                            <span class="lead"><i class="bi bi-envelope-at-fill"></i> How to reach me : 
                                <a href="mailto:parimimonishgmail.com" class="btn btn-sm btn-primary fw-bold">Email</a>
                            </span>
                            <br /><br />
                            ...
                            <p class="btn-group">
                                <a href="https://linkedin.com/in/parimi-monish-a3860a281" target="_blank" class="btn btn-sm btn-success fw-bold"><i class="bi bi-linkedin"></i> LinkedIn</a>
                                <a href="https://github.com/monish-parimi" target="_blank" class="btn btn-warning btn-sm fw-bold"><i class="bi bi-github"></i> GitHub</a>
                                <a href="https://www.instagram.com/parimimonish_693/" target="_blank" class="btn btn-danger btn-sm fw-bold"><i class="bi bi-github"></i> Instagram</a>
                            </p>
                    ...
                    <div class="col-md-5 text-center d-none d-md-block">
                        <span class="tt" data-bs-placement="bottom" title="PARIMI MONISH">
                ...
                <div class="row my-5 aligh-items-center justify-content-center">
                    ...
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-primary border-2">
                            <h4 class="card-header border-primary text-center">Android App Development</h4>
                            <div class="card-body text-center py-4">
                                <h5 class="card-title">Apps made easier through Kotlin Jetpack Compose</h5>
                                <p class="card-text mx-3 my-1 text-muted d-none d-lg-block">Android Jetpack Compose is a modern UI toolkit for building native Android apps. It simplifies UI development with a declarative, composable approach, enhancing efficiency and flexibility.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-8 col-lg-4 col-xl-3">
                    ...
                    <div class="col-lg-6">
                        <form action="">
                            ...
                            <div class="mb-4 input-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="e.g. Parimi Monish" required/>
                            ...
                            <div class="input-group mb-4">
                                ...
                                <select class="form-select" aria-label="Default select example" id="subject">
                                    ...
                                    <option value="android app developmentt">Android App Development</option>
